...
const CRM = {
  en: {
    ...
    add_contact: '＋ Add contact', quotes_link: '📄 Quotes &amp; Orders', merge_by: 'Merge duplicates by',
  ...
  es: {
    ...
    add_contact: '＋ Añadir contacto', quotes_link: '📄 Cotizaciones y pedidos', merge_by: 'Unir duplicados por',
  ...
  pt: {
    ...
    add_contact: '＋ Adicionar contato', quotes_link: '📄 Orçamentos e pedidos', merge_by: 'Mesclar duplicatas por',
