...
<body>
  <div class="header">
    ...
    <div><a href="/admin/tickets" style="color:#fff;font-weight:700">🎫 Tickets${openTickets ? ` (${openTickets})` : ''}</a> · <a href="/admin/legal" style="color:#fff;font-weight:700">📄 Legal</a> · <a href="/admin/audit" style="color:#fff;font-weight:700">🧾 Audit</a> · <span class="who">${esc(user.email)}</span> · <a href="/logout">Sign out</a></div>
  </div>
  <div class="wrap">
    <div class="stats">
