...
export const en = {
  ...
  cust: {
    ...
    seo_ai_btn: '✨ AI review (2 credits)', seo_ai_busy: 'Reviewing…', seo_ai_done: 'AI suggestion filled in — review and hit Save SEO.', seo_ai_err: 'SEO review failed — please try again.',
