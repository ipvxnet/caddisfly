...
export const en = {
  ...
  storem: {
    ...
    media_label: 'Catalogue media (optional)', media_gallery: 'Gallery image URLs', stock_label: 'Stock', stock_hint: 'leave blank for unlimited; 0 = out of stock', media_videos: 'Video URLs', media_files: 'PDF / files', media_links: 'Links', media_perline: 'one per line', media_files_hint: 'Name | URL', media_files_ph: 'Datasheet | https://…/spec.pdf', media_links_hint: 'Label | URL', media_links_ph: 'Manufacturer | https://…', upload_pdf: '⬆ Upload PDF', upload_image: '⬆ Upload picture', from_drive: '🗂 From Drive', drive_title: 'Insert from your Drive', drive_empty: 'No images in your Drive yet — upload some on the Drive page.', drive_loading: 'Loading…', drive_err: 'Could not load your Drive.',
