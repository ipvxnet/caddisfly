...
export const en = {
  ...
  landing: {
    ...
    rf_mode_label: 'How should we build it?',
    rf_mode_match: 'Match my current site',
    rf_mode_match_hint: 'Keep your real text and photos, section by section.',
    rf_mode_fresh: 'Reimagine it',
    rf_mode_fresh_hint: 'A fresh AI-designed site from your business details.',
  ...
  pricing: {
    ...
    features: {
      ...
      starter: ['3 published sites', '<strong>25 GB</strong> storage', '500 AI credits / mo', '<strong>🛍 Online store</strong> — sell with your own Stripe (<strong>250 products</strong>)', '📅 Bookings — <strong>50 services</strong> + <strong>💳 paid bookings</strong>', '1 custom domain', 'Remove “Built with Caddisfly”', 'AI image generation', '✨ AI logo generator', '5 saved versions', 'Email support'],
      pro: ['15 published sites', '<strong>100 GB</strong> storage', '2,000 AI credits / mo', '🛍 Online store — <strong>1,000 products</strong>', '📅 Bookings — <strong>200 services</strong>', '5 custom domains', 'Priority AI image generation', '✨ AI logo generator', '10 saved versions', 'Everything in Starter', 'Priority support'],
  ...
  sed: {
    ...
    nav_show: 'Show in menu', nav_show_hint: 'Include this section as an item in the navigation menu.',
    ...
    no_photos: 'No photos yet — click “Add photo”.', g_drag: 'Drag to reorder', g_alt_ph: 'Describe this photo (alt text)', g_title_ph: 'Title (optional)', g_desc_ph: 'Description (optional)', g_link_ph: 'Link — pick a page, #section, or paste a URL', g_show: 'Show photos', g_show_hint: 'Re-list the photos already on this section', g_banner_image: 'Banner background image', g_cta_text: 'Button text (optional)', g_cta_text_ph: 'e.g. Request a quote', g_cta_link: 'Button link',
  ...
  dom: {
    ...
    addr_current: 'Your site address:', addr_change: '✏️ Change site address', addr_once: 'You can change your site address only once — choose carefully.', addr_save: 'Save address', addr_locked: 'Your site address has already been changed (it can only be changed once).',
    addr_reserved_label: 'Reserved address:', addr_reserved_note: '— goes live when you publish', addr_pick: '📍 Choose your site address', addr_reserve_btn: 'Reserve address', addr_prepub: 'Pick the address your site will use when you publish — instead of an auto-generated one. You can change it freely until you publish.', addr_confirm_reserve: 'Reserve “{name}” as your site address?',
    addr_checking: 'Checking…', addr_available: 'available', addr_taken: 'That address is taken — try one of these:', addr_is_current: 'That’s already your current address.', addr_suggest: 'Available names:', addr_saving: 'Saving…', addr_saved: 'Saved ✓ — updating…', addr_confirm: 'Change your site address to “{name}”? This can only be done once.', addr_too_short: 'Too short (min 3 characters).', addr_too_long: 'Too long (max 40 characters).', addr_reserved: 'That name is reserved — pick another.', addr_empty: 'Enter a name.',
