...
export const es = {
  ...
  blogm: {
    ...
    social_intro: 'Pega la URL de un webhook entrante de Discord o Slack. Las nuevas publicaciones se anuncian allí automáticamente al republicar — o usa “Compartir” en cualquier publicación publicada.',
