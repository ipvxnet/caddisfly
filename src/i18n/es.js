...
export const es = {
  ...
  cust: {
    ...
    seo_ai_btn: '✨ Revisión con IA (2 créditos)', seo_ai_busy: 'Revisando…', seo_ai_done: 'Sugerencia de la IA aplicada — revísala y pulsa Guardar SEO.', seo_ai_err: 'La revisión SEO falló — inténtalo de nuevo.',
