...
export const es = {
  ...
  landing: {
    ...
    hero_h1_html: 'El <span class="grad-text">creador de webs con IA</span> gratis<br>que crea tu sitio por ti.',
    ...
    seo_title: 'Creador de Webs con IA Gratis — Crea tu Sitio Conversando | Caddisfly',
    seo_desc: 'Caddisfly es un creador de páginas web con IA gratis. Describe tu negocio y la IA crea un sitio completo, adaptable al móvil y listo para SEO en minutos — o renueva tu web actual. Sin código, gratis para empezar.',
    faq_title: 'Preguntas frecuentes',
    faqs: [
      ['¿Caddisfly es gratis?', 'Sí — crear y previsualizar tu web es gratis. Publica en el plan gratuito con una dirección caddisfly.app, o mejora para quitar la marca y conectar un dominio propio.'],
      ['¿La IA realmente crea mi web?', 'Sí. Describe tu negocio y la IA de Caddisfly genera un sitio completo de varias páginas — textos, secciones, imágenes y diseño — que puedes editar y publicar.'],
      ['¿Necesito saber programar?', 'No. Todo es visual y asistido por IA — sin código y sin plantillas complicadas. Edita cualquier texto, imagen o sección en unos clics.'],
      ['¿En qué se diferencia de otros creadores de webs?', 'En lugar de arrastrar bloques en una página en blanco, chateas con la IA (o pegas tu web actual) y obtienes un sitio terminado en minutos — luego lo afinas.'],
      ['¿Puedo usar mi propio dominio?', 'Sí. Conecta un dominio propio en un plan de pago, o cómpralo dentro de Caddisfly y lo conectamos automáticamente.'],
    ],
    ...
    rf_q_name: 'Nombre del negocio',
    rf_q_name_ph: 'p. ej. Clínica Nouva',
    rf_q_search: 'La mejor forma de encontrarte en Google',
    rf_q_search_ph: 'p. ej. Clínica Nouva dentista Florianópolis',
    rf_q_search_help: 'Si tu sitio nos bloquea, usamos esto para hallar tus fotos, reseñas y datos en Google.',
    rf_more: '+ Añadir más detalles (opcional, mejora el resultado)',
    rf_q_services: 'Servicios o productos principales',
    rf_q_services_ph: 'p. ej. implantes dentales, limpiezas, blanqueamiento',
    rf_q_area: 'Ciudad / zona que atiendes',
    rf_q_area_ph: 'p. ej. Florianópolis, SC',
    rf_q_phone: 'Teléfono',
    rf_q_phone_ph: 'p. ej. +55 48 99999-9999',
    rf_q_address: 'Dirección',
    rf_q_address_ph: 'Calle, ciudad',
    rf_q_logo: 'URL del logo',
    rf_q_colors: 'Colores de marca',
    ...
    rf_refine: 'Ajustar',
    rf_remaining: 'Te quedan {n} búsquedas de vista previa hoy',
    rf_limit: 'Has usado las vistas previas de hoy. Inténtalo de nuevo mañana.',
    rf_building: 'Creando…',
    rf_built: '¡Tu sitio está listo! Revisa tu correo para el enlace.',
    rf_view: 'Ver tu sitio →',
    rf_nomatch: 'No encontramos mucho automáticamente: puedes crear igualmente y añadir detalles y fotos después.',
    rf_mode_label: '¿Cómo lo creamos?',
    rf_mode_match: 'Replicar mi sitio actual',
    rf_mode_match_hint: 'Mantén tu texto y tus fotos reales, sección por sección.',
    rf_mode_fresh: 'Reimaginarlo',
    rf_mode_fresh_hint: 'Un sitio nuevo diseñado por IA a partir de los datos de tu negocio.',
    ...
    feat_fast_d: 'Cada sitio obtiene 90+ en Google PageSpeed (móvil) de forma automática — imágenes AVIF/WebP de nueva generación redimensionadas al vuelo, fuentes que no bloquean y cero saltos de diseño. Rápido para tus visitantes y querido por Google.',
  ...
  loading: {
    ...
    retry: 'Reintentar',
    err_generation: 'Algo salió mal. Inténtalo de nuevo.',
  },
  ...
  convo: {
    ...
    q: {
      business_status: '¿Ya tienes un sitio web para tu negocio?',
      data_mode: '¿Cómo te gustaría crear tu sitio?',
      detailed_form: 'Cuéntanos sobre tu negocio',
    ...
    opt: {
      new_business_l: 'Negocio nuevo — aún sin sitio web', new_business_d: 'Empiezo desde cero y quizá también necesite un logo',
      existing_business_l: 'Negocio existente — ya tengo un sitio web', existing_business_d: 'Ya tengo presencia en línea',
      detailed_l: 'Usar los datos reales de mi negocio', detailed_d: 'Logo, historia, fundadores, servicios, fotos, redes sociales — para el mejor resultado',
      ai_generated_l: 'Que la IA lo genere por ahora', ai_generated_d: 'La IA redacta el texto y elige las imágenes; agregaré los detalles más tarde',
      ...
      products_l: 'Tienda online', products_d: 'Vende productos con pago por Stripe',
      booking_l: 'Reservas', booking_d: 'Deja que los visitantes reserven citas — servicios, horarios, pagos',
      blog_l: 'Blog', blog_d: 'Blog asistido por IA — redactamos tu primera publicación',
    ...
    form: {
      ...
      subtitle: 'Cuanto más compartas, mejor será tu sitio. Todo es opcional excepto el nombre del negocio — la IA completa lo que falte, mejora la redacción y corrige la gramática.',
      prefill_label: '¿Ya tienes un sitio web?',
      website_url_ph: 'https://tunegocio.com',
      prefill_btn: '🔎 Revisar mi sitio y autocompletar',
      prefill_checking: 'Investigando tu negocio…',
      prefill_stage_scrape: 'Leyendo tu sitio web…',
      prefill_stage_search: 'Buscando tu negocio en Google…',
      prefill_stage_photos: 'Recopilando fotos, horarios y reseñas…',
      prefill_done: 'Hemos rellenado lo que encontramos — revísalo y complétalo, por favor.',
      prefill_none: 'No encontramos mucho automáticamente — completa lo que puedas abajo.',
      business_name_label: 'Nombre del negocio *',
      business_name_ph: 'p. ej., Dulces Delicias Panadería',
      history_label: 'La historia de tu negocio',
      history_ph: 'Cuándo y por qué empezaste, hitos, qué te diferencia…',
      founder_label: 'Sobre el fundador (o sobre ti)',
      founder_ph: 'Quién dirige el negocio, su trayectoria, la historia detrás…',
      services_label: 'Servicios o productos que ofreces',
      services_ph: 'Enumera tus principales servicios o productos, uno por línea…',
      social_title: 'Redes sociales (todas opcionales)',
      demographics_label: '¿Quiénes son tus clientes?',
      demographics_ph: 'p. ej., Familias locales, parejas que planean su boda, pequeñas empresas…',
      area_label: '¿Dónde prestas servicio?',
      area_city: 'Una ciudad / zona local',
      area_country: 'Todo un país',
      area_world: 'Todo el mundo / en línea',
      area_value_ph: 'p. ej., Madrid o España',
      ...
      logo_label: 'Tu logo',
      logo_btn: 'Subir logo',
      logo_hint: '¿Sin logo? Déjalo vacío — puedes generar uno más tarde.',
      pictures_label: 'Fotos de tu negocio, trabajo o equipo',
      pictures_btn: 'Subir fotos',
      uploading: 'Subiendo…',
      submit: 'Crear mi sitio web →',
      submitting: 'Guardando…',
      required_err: 'Por favor, escribe el nombre de tu negocio.',
  ...
  pricing: {
    ...
    plugins_note: '¿Necesitas más? Plugins opcionales — Cursos, Miembros, Catálogo, CRM y Tienda Avanzada — $5/mes cada uno, o ahorra con un paquete →',
  ...
  dash: {
    ...
    sites_you_manage: 'Sitios que administras', sites_you_manage_sub: 'Sitios transferidos a otro propietario que aún ayudas a administrar.',
    managed_for: 'Administrado para {owner}',
    mgr_builder_access: 'Acceso del creador', mgr_disconnect: 'Desvincular',
    mgr_note: 'Esta persona puede editar y publicar este sitio. Desvincúlala para terminar la relación — siempre puedes volver a invitarla como miembro del equipo.',
    mgr_disconnect_confirm: '¿Desvincular a {email}? Perderá el acceso a este sitio de inmediato.',
    all_sites: 'Todos los sitios', specific_sites: 'Sitios específicos', n_sites: '{n} sitios', save_access: 'Guardar acceso',
  ...
  limit: {
    over_title: 'Tienes {count} sitios publicados — tu plan {plan} permite {limit}.',
    over_body: 'Tus sitios en vivo siguen en línea, pero no puedes publicar más hasta volver al límite. Despublica {overBy} sitio(s) o mejora tu plan.',
    over_cta: 'Gestionar plan',
  },
  ...
  cust: {
    ...
    crm: '👥 CRM', courses: '📚 Cursos', courses_title: 'Cursos en línea — lecciones, videos, cuestionarios y ventas', members: '👤 Miembros', members_title: 'Los miembros de tu sitio — inicios de sesión y contenido exclusivo', manage: 'Gestionar', drive_browse: '📂 Explorar Drive', drive_browse_title: 'Explora archivos en Drive — abre documentos, PDF y hojas de cálculo compartidos',
  ...
  blogm: {
    ...
    tab_posts: '✍️ Publicaciones', tab_settings: '⚙️ Ajustes',
  ...
  bkm: {
    ...
    svc_deposit: 'Depósito', svc_deposit_title: 'Cobra solo este importe fijo al reservar (debe ser menor que el precio); el resto se paga en la cita. Las cancelaciones antes del límite devuelven el depósito.',
  ...
  bkw: {
    ...
    pay_btn: 'Reservar y pagar', deposit_btn: 'Reservar — depósito de {amt}', f_pay_submit: 'Continuar al pago', your_time: 'tu hora:',
  ...
  bkr: {
    ...
    remaining: 'Pendiente de pago en tu cita: {amt}',
  ...
  bkres: {
    ...
    not_found: 'Este enlace de cambio no es válido, ha caducado o la reserva fue cancelada.',
    prev: 'Antes', next: 'Después', loading: 'Cargando horarios…',
    no_slots: 'No hay horarios disponibles en este periodo — prueba los días siguientes.',
    too_late_title: 'Esta reserva ya no se puede cambiar online', too_late: 'La cita ya tuvo lugar o está demasiado cerca de su hora de inicio. Contacta directamente con el negocio.',
    pick: 'Nuevo horario:', confirm_btn: 'Confirmar nuevo horario', moving: 'Moviendo tu reserva…',
    err: 'Algo salió mal. Inténtalo de nuevo.',
    taken: 'Ese horario se acaba de ocupar — elige otro.',
  },
  bkc: {
    ...
    too_late_title: 'Esta reserva ya no se puede cambiar online', too_late: 'La cita ya tuvo lugar o está demasiado cerca de su hora de inicio. Contacta directamente con el negocio — ellos pueden ayudarte.',
    or_reschedule: '¿Solo necesitas otro horario?', reschedule_link: 'Elige un nuevo horario →',
  ...
  drivex: {
    title: 'Insertar desde Drive', open: 'Abrir ↗', use: 'Usar',
    no_files: 'Aún no hay archivos que coincidan en Drive.',
  },
  sed: {
    ...
    from_drive: '🗂 Desde Drive', drive_title: 'Insertar desde tu Drive', drive_empty: 'Aún no hay imágenes en tu Drive — sube algunas en la página Drive.', drive_loading: 'Cargando…', drive_err: 'No se pudo cargar tu Drive.', drive_site: 'Drive del sitio', drive_mine: 'Mi Drive', drive_shared_hint: 'Archivos compartidos por el propietario (su carpeta “Shared” en Drive).', drive_shared_empty: 'El propietario aún no ha compartido imágenes — puede mover archivos a su carpeta “Shared” en Drive.', drive_all_folders: 'Todas', drive_folder_empty: 'Esta carpeta no tiene imágenes.',
    ...
    f_image: 'Foto', img_upload: 'Subir', img_drive: 'Drive', img_url: 'URL', img_photo: 'Sugerir', img_ai: 'IA', img_remove: 'Quitar',
    swap_all: 'Cambiar todas las fotos con IA', img_url_prompt: 'Pega una URL de imagen',
    img_finding: 'Buscando una foto…', img_generating: 'Generando…', img_fail: 'Falló — inténtalo de nuevo',
    f_name: 'Nombre', f_role: 'Cargo / empresa', f_quote: 'Cita', f_rating: 'Valoración (1–5)', f_video: 'Video (opcional)', video_ph: 'Enlace de YouTube, Vimeo o Loom',
    ...
    no_photos: 'Aún no hay fotos — haz clic en “Añadir foto”.', g_drag: 'Arrastra para reordenar', g_alt_ph: 'Describe esta foto (texto alternativo)', g_title_ph: 'Título (opcional)', g_desc_ph: 'Descripción (opcional)', g_link_ph: 'Enlace — elige una página, #sección o pega una URL', g_show: 'Mostrar fotos', g_show_hint: 'Volver a listar las fotos ya en esta sección', g_banner_image: 'Imagen de fondo del banner', g_cta_text: 'Texto del botón (opcional)', g_cta_text_ph: 'p. ej. Solicitar cotización', g_cta_link: 'Enlace del botón',
    ...
    mbr_heading_ph: 'Acceso de miembros',
  ...
  aip: {
    ...
    upload_file: 'Subir un archivo', from_drive: 'Elegir de Drive', or_paste_url: '…o pega una URL', use: 'Usar',
  ...
  logo: {
    ...
    from_drive: 'Elegir de Drive',
  },
  favicon: {
    summary: 'Favicon (icono de la pestaña)',
    hint: 'El icono pequeño en la pestaña del navegador. Déjalo vacío para usar tu logo. Un PNG o SVG cuadrado funciona mejor.',
    none: 'Usando tu logo como favicon.',
    upload: 'Sube un favicon (PNG, SVG, ICO):',
    remove: 'Quitar favicon',
  ...
  dom: {
    ...
    addr_reserved_label: 'Dirección reservada:', addr_reserved_note: '— se activa cuando publiques', addr_pick: '📍 Elige la dirección de tu sitio', addr_reserve_btn: 'Reservar dirección', addr_prepub: 'Elige la dirección que usará tu sitio al publicar — en vez de una generada automáticamente. Puedes cambiarla libremente hasta que publiques.', addr_confirm_reserve: '¿Reservar «{name}» como la dirección de tu sitio?',
  ...
  help: {
    ...
    toc: [
      ...
      ['logo', 'Logo y marca'],
      ['publishing', 'Publicar'], ['qr', 'Código QR'], ['store', 'Tienda online'], ['courses', 'Cursos y formación'], ['members', 'Miembros e inicio de sesión'], ['bookings', 'Reservas'],
      ...
      ['team', 'Miembros del equipo'], ['transfer', 'Transferir un sitio y el acceso'], ['faq', 'Preguntas frecuentes'],
    ],
    sections: [
      ...
      ['courses', 'Cursos y formación', `
        ...
        <p><strong>Cursos pagos</strong> usan su propia cuenta de Stripe (la misma conexión que la tienda). Los compradores se identifican con un enlace de correo electrónico sin contraseña y se inscriben en el momento en que pagan, luego ven cada lección directamente en su sitio — también reciben un enlace de acceso privado por correo electrónico. <strong>Cursos gratuitos</strong> permanecen abiertos para todos. ¿Quiere que el catálogo también sea privado? Active <strong>🔒 Solo para miembros</strong> en el administrador de Cursos para que los visitantes deban iniciar sesión para navegar (requiere el complemento <a href="#members">Miembros</a>).</p>`],
      ['members', 'Miembros e inicio de sesión', `
        <p>El complemento <strong>Miembros</strong> permite que los visitantes creen una cuenta gratuita en su sitio y desbloquean contenido <strong>solo para miembros</strong>. Es un <strong>complemento de $5/mes</strong> (también incluido en el paquete Creators &amp; Coaches); habilítelo desde <a href="/plugins">Plugins</a>.</p>
        <ul>
          <li><strong>Inicio de sesión sin contraseña</strong> — los visitantes ingresan su correo electrónico y reciben un enlace mágico de inicio de sesión (sin contraseña). Agregue una caja <strong>+ Agregar sección → 👤 Inicio de sesión de miembro</strong> en cualquier lugar para que las personas puedan iniciar sesión, ver su cuenta y cerrar sesión.</li>
          <li><strong>Páginas solo para miembros</strong> — en el panel <strong>Páginas</strong>, marque <strong>🔒 Solo para miembros</strong> en cualquier página. Una vez publicada, esa página muestra solo una caja de inicio de sesión; el contenido real se entrega a los miembros registrados y nunca aparece en la página pública.</li>
          <li><strong>Secciones solo para miembros</strong> — ¿quiere restringir solo parte de una página? Abra el editor de una sección y marque <strong>🔒 Solo para miembros</strong>; el resto de la página permanece pública.</li>
          <li><strong>Su lista de miembros</strong> — vea a todos los que han iniciado sesión bajo <strong>Gestionar ▾ → Miembros</strong>: exporte a CSV, o bloquee y elimine personas.</li>
        </ul>
        <p>"Solo para miembros" significa que <em>los visitantes deben iniciar sesión</em> — cualquiera puede crear una cuenta, por lo que no es exclusivo por invitación. Párelo con <a href="#courses">Cursos</a> para crear un área de aprendizaje privada.</p>`],
      ['bookings', 'Reservas', `
        ...
        <ul>
          ...
          <li><strong>Lo que reciben tus visitantes</strong> — un email de confirmación con archivo para <em>añadir al calendario</em> y enlaces de un clic para <em>cambiar la hora</em> o <em>cancelar</em>, un recordatorio ~24 horas antes, y las horas en su propia zona horaria al elegir. La autogestión se detiene en tu <em>límite de cancelación</em> (Ajustes de reservas) y siempre cuando la cita ya comenzó — después, solo tú puedes cancelar (y reembolsar) desde la bandeja.</li>
          ...
          <li><strong>Cobra al reservar</strong> (planes de pago) — pon precio a un servicio y marca <strong>💳 Requerir pago</strong>: los visitantes pagan en Stripe Checkout (tu cuenta de Stripe conectada, como la tienda) antes de confirmar la cita, y las cancelaciones se reembolsan automáticamente. Define un <strong>depósito</strong> opcional para cobrar solo una parte por adelantado — el resto se paga en la cita, y los emails detallan el saldo pendiente para ambas partes.</li>
      ...
      ['performance', 'Velocidad y rendimiento', `
        <p>Cada sitio de Caddisfly está hecho para ser <strong>rápido automáticamente</strong> — no hay nada que configurar. Los sitios publicados obtienen <strong>90+ en Google PageSpeed Insights</strong> (móvil), lo que significa una mejor experiencia para tus visitantes y una señal de posicionamiento que Google premia. Por dentro:</p>
        <ul>
          <li><strong>Imágenes de nueva generación</strong> — cada foto se redimensiona al tamaño en que realmente se muestra y se sirve en <strong>AVIF/WebP</strong>, normalmente <strong>85–90% más ligera</strong> que el original — sin que tengas que hacer nada.</li>
          <li><strong>Sin saltos de diseño</strong> — las imágenes reservan su espacio para que la página nunca salte mientras carga (un CLS perfecto de 0).</li>
          <li><strong>Texto instantáneo</strong> — las fuentes cargan sin bloquear la página, así tus palabras aparecen de inmediato.</li>
          <li><strong>Carga inteligente</strong> — la imagen principal se prioriza mientras las imágenes de más abajo cargan solo cuando hacen falta.</li>
          <li><strong>Estructura limpia y accesible</strong> — puntos de referencia y encabezados correctos que se combinan con el <a href="#seo">SEO automático</a> de arriba.</li>
        </ul>
        <p>Todo esto lo tienes en cualquier plan, tanto en la dirección gratuita <code>caddisfly.app</code> como en dominios propios.</p>`],
      ['buy-domain', 'Comprar un dominio', `
      ...
      ['team', 'Miembros del equipo', `
        ...
        <ul>
          ...
          <li><strong>Acceso por sitio</strong> — cuando invites a alguien, elige <strong>Todos los sitios</strong> o selecciona <strong>sitios específicos</strong> en los que pueden trabajar, y establece su rol. Puedes cambiarlo en cualquier momento desde la fila del miembro. Los miembros solo ven y editan los sitios que se les asignan.</li>
        </ul>`],
      ['transfer', 'Transferir un sitio y el acceso', `<p>Mueve un sitio web completo a otra cuenta — útil para agencias que entregan un sitio terminado a un cliente. Abre el sitio en <strong>Personalizar</strong> y haz clic en <strong>⇄ Transferir</strong> (planes Pro y Agency).</p><ul><li><strong>Cómo funciona</strong> — ingresa el correo electrónico del destinatario; recibirán una invitación con un enlace para iniciar sesión. Una vez que acepten, <strong>ellos poseerán el sitio</strong> — se facturará y se gestionará por completo según <em>su</em> plan (plugins, créditos de IA, límites). Nada se traslada de tu cuenta.</li><li><strong>Requisitos</strong> — si el sitio utiliza un dominio personalizado o plugins pagados, el destinatario necesita un plan compatible. La página de aceptación muestra exactamente qué se necesita y ofrece <strong>una compra combinada</strong> para configurar todo antes de finalizar.</li><li><strong>Mantener el acceso del creador</strong> — marca esta opción para seguir siendo <strong>Gestor</strong> después de la transferencia: aún podrás editar y publicar el sitio (aparecerá bajo <strong>Sitios que administras</strong> en tu panel de control) y contará hacia el límite de sitios de tu propio plan. El nuevo dueño puede eliminarte en cualquier momento desde el panel de <strong>Acceso del creador</strong> de su sitio.</li><li><strong>¿Estás por encima del límite de tu plan?</strong> — si una reducción de plan o una transferencia entrante te deja con más sitios publicados de lo que permite tu plan, tus sitios en vivo permanecerán en línea, pero no podrás publicar más hasta que estés dentro del límite. Un banner te mostrará qué hacer — despublicar un sitio o actualizar tu plan.</li></ul>`],
    ],
    faqs: [
      ...
      ['¿Puedo vender suscripciones o membresías?', 'Sí. Para facturación recurrente, agregue una sección <strong>Precios</strong> y asocie un precio recurrente de Stripe a una tarjeta de plan — el botón se convierte en un checkout activo de <strong>Suscribirse</strong> y Stripe maneja las renovaciones. Para poner contenido detrás de un inicio de sesión, agregue el complemento <strong>Miembros</strong> y marque páginas o secciones como <strong>solo para miembros</strong> (vea <a href="#members">Miembros e inicio de sesión</a>).'],
      ...
      ['¿Puedo cobrar por las reservas — o pedir un depósito?', 'Sí, en planes de pago con Stripe conectado: marca <strong>💳 Requerir pago</strong> en un servicio y los visitantes pagan el precio completo en Stripe Checkout antes de confirmar la cita — o define un <strong>depósito</strong> para cobrar una parte por adelantado y el resto en la cita. Las cancelaciones antes de tu límite se reembolsan automáticamente; el recibo y el importe pagado van en el email de confirmación. Ver <a href="#bookings">Reservas</a>.'],
      ['¿Puede mi sitio vestirse de fiesta?', 'Sí — en el panel de <strong>Diseño</strong> del editor, activa <strong>🎄 Temas festivos</strong> y elige tus festividades: una semana antes de cada una tu sitio luce colores a juego (más toques animados discretos como el vuelo de Papá Noel — opcionales), y después vuelve a la normalidad y se republica solo.'],
      ...
      ['¿Puedo transferir un sitio web a un cliente u otra cuenta?', 'Sí, en los planes Pro y Agency. Abre el sitio en <strong>Personalizar → ⇄ Transferir</strong>, ingresa el correo electrónico del destinatario y ellos aceptarán a través de un enlace por correo. Una vez aceptado, ellos poseerán completamente el sitio — se facturará y se gestionará según su plan, sin nada heredado de tu cuenta. Puedes optar por <strong>mantener el acceso del creador</strong> para seguir editándolo como Gestor. Ver <a href="#transfer">Transferir un sitio y el acceso</a>.'],
      ['¿Puedo limitar a un miembro del equipo a ciertos sitios?', 'Sí. Cuando invites a alguien (Panel → Equipo), elige <strong>Todos los sitios</strong> o selecciona <strong>sitios específicos</strong>, y establece su rol. Puedes cambiar a qué sitios pueden acceder en cualquier momento desde su fila. Ver <a href="#team">Miembros del equipo</a>.'],
      ['¿Qué ocurre si tengo más sitios publicados de lo que permite mi nuevo plan?', 'Tus sitios en vivo permanecerán en línea — nunca los bajamos automáticamente — pero no podrás publicar más sitios hasta que estés dentro del límite de tu plan. Verás un banner que te indicará que debes despublicar un sitio o actualizar tu plan. Esto puede ocurrir después de una reducción de plan o después de aceptar una transferencia de sitio.'],
      ['¿Puedo hacer parte de mi sitio solo para miembros?', 'Sí — con el complemento <strong>Miembros</strong> puede requerir un inicio de sesión gratuito para ver cualquier página o sección, incluso todo el catálogo de cursos. Los visitantes inician sesión con un enlace de correo electrónico sin contraseña; usted gestiona quién tiene acceso bajo <strong>Gestionar ▾ → Miembros</strong>. Vea <a href="#members">Miembros e inicio de sesión</a>.'],
      ['¿Las personas necesitan una cuenta para tomar mis cursos?', 'Los cursos gratuitos están abiertos para todos. Para <strong>cursos pagos</strong>, los compradores inician sesión y se inscriben cuando pagan, luego ven cada lección en su sitio (con un enlace de acceso de respaldo por correo electrónico). Vea <a href="#courses">Cursos y formación</a>.'],
