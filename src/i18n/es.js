...
export const es = {
  ...
  cust: {
    ...
    add_group: '+ Grupo de menú', menu_parent: 'Menú superior', menu_top_level: 'Nivel superior', menu_has_children: 'tiene elementos de submenú', menu_show: 'Mostrar en el menú', menu_sections_sub: 'Secciones como submenú',
