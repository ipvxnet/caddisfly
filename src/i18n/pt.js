...
export const pt = {
  ...
  sed: {
    ...
    from_drive: '🗂 Do Drive', drive_title: 'Inserir do seu Drive', drive_empty: 'Ainda não há imagens no seu Drive — carregue algumas na página Drive.', drive_loading: 'Carregando…', drive_err: 'Não foi possível carregar seu Drive.', drive_site: 'Drive do site', drive_mine: 'Meu Drive',
