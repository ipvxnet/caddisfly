...
export const pt = {
  ...
  sed: {
    ...
    no_photos: 'Ainda não há fotos — clique em “Adicionar foto”.', g_drag: 'Arraste para reordenar', g_alt_ph: 'Descreva esta foto (texto alternativo)', g_title_ph: 'Título (opcional)', g_desc_ph: 'Descrição (opcional)', g_link_ph: 'Link — #seção ou https://… (opcional)', g_show: 'Mostrar fotos', g_show_hint: 'Listar novamente as fotos já nesta seção', g_banner_image: 'Imagem de fundo do banner', g_cta_text: 'Texto do botão (opcional)', g_cta_text_ph: 'ex.: Solicitar orçamento', g_cta_link: 'Link do botão',
