...
export const pt = {
  ...
  landing: {
    ...
    rf_mode_label: 'Como devemos criar?',
    rf_mode_match: 'Replicar meu site atual',
    rf_mode_match_hint: 'Mantenha seu texto e suas fotos reais, seção por seção.',
    rf_mode_fresh: 'Reimaginar',
    rf_mode_fresh_hint: 'Um site novo desenhado por IA a partir dos dados do seu negócio.',
  ...
  dash: {
    ...
    customize: 'Personalizar', analytics: 'Estatísticas', inbox: 'Mensagens', blog: 'Blog', store: 'Loja', bookings: 'Reservas', report: '📊 Relatório', open: 'Abrir ↗',
  ...
  storem: {
    ...
    media_label: 'Mídia do catálogo (opcional)', media_gallery: 'URLs de imagens da galeria', stock_label: 'Estoque', stock_hint: 'deixe em branco para ilimitado; 0 = esgotado', media_videos: 'URLs de vídeo', media_files: 'PDF / arquivos', media_links: 'Links', media_perline: 'um por linha', media_files_hint: 'Nome | URL', media_files_ph: 'Ficha técnica | https://…/spec.pdf', media_links_hint: 'Rótulo | URL', media_links_ph: 'Fabricante | https://…', currency_label: 'Moeda', currency_hint: 'Detectada automaticamente da sua conta Stripe conectada. Aplica-se à sua loja e reservas pagas.', currency_saved: 'Salvo ✓', pix_note_title: '🇧🇷 Aceite PIX e boleto (Brasil)', pix_note_body: 'PIX e boleto são ativados no seu próprio Painel da Stripe, não aqui. Abra Configurações → Formas de pagamento e ative PIX e Boleto — eles então aparecem automaticamente no checkout para seus clientes. O boleto compensa 1–2 dias úteis após o cliente pagar; o pedido, a reserva ou o curso é registrado automaticamente quando compensa.', pix_note_link: 'Abrir formas de pagamento da Stripe ↗', upload_pdf: '⬆ Enviar PDF', upload_image: '⬆ Enviar imagem', from_drive: '🗂 Do seu Drive', drive_title: 'Inserir do seu Drive', drive_empty: 'Ainda não há imagens no seu Drive — envie algumas na página do Drive.', drive_loading: 'Carregando…', drive_err: 'Não foi possível carregar seu Drive.',
  ...
  sed: {
    ...
    nav_show: 'Mostrar no menu', nav_show_hint: 'Incluir esta seção como um item do menu de navegação.',
    nav_label: 'Nome no menu', nav_label_ph: 'ex.: Componentes', nav_label_hint: 'Como esta seção aparece no menu de navegação. Deixe em branco para usar o padrão.',
    ...
    from_drive: '🗂 Do Drive', drive_title: 'Inserir do seu Drive', drive_empty: 'Ainda não há imagens no seu Drive — carregue algumas na página Drive.', drive_loading: 'Carregando…', drive_err: 'Não foi possível carregar seu Drive.', drive_site: 'Drive do site', drive_mine: 'Meu Drive', drive_shared_hint: 'Arquivos compartilhados pelo proprietário (a pasta “Shared” do Drive dele).', drive_shared_empty: 'O proprietário ainda não compartilhou imagens — ele pode mover arquivos para a pasta “Shared” no Drive.', drive_all_folders: 'Todas', drive_folder_empty: 'Esta pasta não tem imagens.',
    ...
    no_photos: 'Ainda não há fotos — clique em “Adicionar foto”.', g_drag: 'Arraste para reordenar', g_alt_ph: 'Descreva esta foto (texto alternativo)', g_title_ph: 'Título (opcional)', g_desc_ph: 'Descrição (opcional)', g_link_ph: 'Link — escolha uma página, #seção ou cole uma URL', g_show: 'Mostrar fotos', g_show_hint: 'Listar novamente as fotos já nesta seção', g_banner_image: 'Imagem de fundo do banner', g_cta_text: 'Texto do botão (opcional)', g_cta_text_ph: 'ex.: Solicitar orçamento', g_cta_link: 'Link do botão',
    ...
    igf_heading_ph: 'O que há de novo',
  ...
  dom: {
    ...
    addr_reserved_label: 'Endereço reservado:', addr_reserved_note: '— fica ativo quando você publicar', addr_pick: '📍 Escolha o endereço do seu site', addr_reserve_btn: 'Reservar endereço', addr_prepub: 'Escolha o endereço que seu site usará ao publicar — em vez de um gerado automaticamente. Você pode alterá-lo livremente até publicar.', addr_confirm_reserve: 'Reservar «{name}» como o endereço do seu site?',
