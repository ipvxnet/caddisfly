...
export async function updateWebsiteConfigById(db, configId, data) {
  const allowedFields = ['primary_color', 'secondary_color', 'font_heading', 'font_body', 'style_theme', 'social_image', 'auto_snapshot', 'stripe_account_id', 'store_currency', 'logo_url', 'notify_email', 'social_connections_json'];
