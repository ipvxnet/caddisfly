...
const PROFILES = {
  ...
  roofing: { brand: 'Summit Roofing & HVAC', hero: ['Roofing & HVAC, Done Right', 'Licensed, insured, and on time — with upfront pricing and a workmanship guarantee'],
    tags: ['Licensed & Insured', 'Free Estimates', '24/7 Emergency'],
    services: [['Roof Repair & Replacement', 'Leaks, storm damage, and full re-roofs', '🏠'], ['Heating & Cooling', 'AC and furnace install and repair', '❄️'], ['Gutters & Siding', 'Protect your home, top to bottom', '🧱']] },
  therapy: { brand: 'Stillwater Counseling', hero: ['A Calmer Path Forward', 'Compassionate, judgment-free therapy for individuals, couples, and families'],
    services: [['Individual Therapy', 'A safe space to be heard', '🌿'], ['Couples Counseling', 'Reconnect and communicate', '💬'], ['Teletherapy', 'Support from wherever you are', '💻']] },
