...
const DARK_SURFACE_SECTIONS = [
  ...
  '.features-actions',
  '.hero-showcase', '.about-founder', '.cta-split', '.testimonials-video',
...
const DARK_CARD_SURFACES = [
  ...
  '.footer-minimal-social a', '.hero-overlap-card', '.action-card', '.cta-split-copy', '.vt-card',
...
export function darkModeCss(theme) {
  ...
  return `
    ...
    .hero-showcase-sub, .about-founder-role, .cta-split-desc, .vt-quote, .vt-role { color: ${s.muted} !important; }
    ...
    .about-founder-quote, .about-founder-name, .vt-name { color: ${s.text} !important; }
