...
const DARK_SURFACE_SECTIONS = [
  ...
  '.gallery-section', '.gallery-carousel', '.gallery-cards-section', '.gallery-banner-section', '.gallery-logos-section',
